<?php
/*
Plugin Name: User Collections Debug
Version: 2.3.2
...
if (basename(dirname(__FILE__)) != 'UserCollections_debug')
{
...
define('USER_COLLEC_PATH',   PHPWG_PLUGINS_PATH . 'UserCollections_debug/');
define('USER_COLLEC_ADMIN',  get_root_url() . 'admin.php?page=plugin-UserCollections_debug');
define('USER_COLLEC_PUBLIC', get_absolute_root_url('false') . make_index_url(array('section' => 'collections')) . '/');
define('USER_COLLEC_RELATIVE',  make_index_url(array('section' => 'collections')) . '/');
